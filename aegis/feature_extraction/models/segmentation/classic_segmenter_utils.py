"""
This file contains the utils for the classic segmenter.

It is a modified version of the original file:
https://github.com/mahmoodlab/CLAM/blob/master/utils/classic_segmenter_utils.py

The main changes are:
- Added a new function to generate the initial mask.
- Added a new function to get the patch size in microns.
- Added a new function to parse the config file.
- Added a new function to check if the mask is too big.
- Added a new function to generate the initial mask.
"""
