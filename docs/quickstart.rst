...
AEGIS provides user-facing command-line scripts for processing large batches of whole-slide images (WSIs).
...
.. code-block:: bash
    ...
    aegis extract_patches --task all --wsi_dir output/wsis --job_dir output --patch_encoder uni_v1 --mag 20 --patch_size 256
...
.. code-block:: bash
    ...
    aegis extract_patches --task seg --wsi_dir input_wsis --job_dir output
...
.. code-block:: bash
    ...
    aegis extract_patches --task coords --wsi_dir input_wsis --job_dir output --mag 20 --patch_size 256
...
.. code-block:: bash
    ...
    aegis extract_patches --task feat --wsi_dir input_wsis --job_dir output --patch_encoder uni_v1 --mag 20 --patch_size 256
...
.. note::
   ...
   .. raw:: html
      ...
      <h3 style="margin-top: 0px; margin-bottom: 10px;">
         🛠️ <b>Command-line Argument Reference (extract_patches)</b>
      </h3>

   .. literalinclude:: generated/aegis_extract_patches_help.txt
      :language: text
...
.. note::
   ...
   .. raw:: html
      ...
      <h3 style="margin-top: 0px; margin-bottom: 10px;">
         🛠️ <b>Command-line Argument Reference (train_mil)</b>
      </h3>

   .. literalinclude:: generated/aegis_train_mil_help.txt
      :language: text
